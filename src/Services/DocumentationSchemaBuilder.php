 ...
 * @phpstan-type ComponentSchemas array<string, SchemaNode>
 * @phpstan-type ResponseSchema array{name: string, schema: SchemaNode}
 * @phpstan-type ExampleNode array<int|string, mixed>
 */
final class DocumentationSchemaBuilder
{
    ...
    /**
     * @param  array<string, mixed>  $endpoint
     * @param  array<string, string>  $customResponseRefs
     * @param  ComponentSchemas  $componentSchemas
    ...
    private function insertExampleValue(
        ...
        if ($segment === '*') {
            ...
            $this->insertExampleValue($arrayItem, $segments, $value);
            $example[0] = $arrayItem;
        ...
        $this->insertExampleValue($nestedExample, $segments, $value);
        $example[$segment] = $nestedExample;
    }
